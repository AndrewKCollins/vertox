...
Vertexy includes a flexible static analysis engine designed to scan Solana Rust source code for programs vulnerabilities, code smells, or user-defined patterns.
...
The sast engineering core in Vertexy is based on the excellent open-source project  

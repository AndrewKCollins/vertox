...
VERTOX is distributed as a Rust command-line application.
...
```bash
git clone <your-vertox-repository-url>
cd vertox
cargo build --release
```
...
During development, prefix VERTOX arguments with `cargo run --`:

...
The `ast` command generates and displays the Abstract Syntax Tree (AST) representation of Rust source files in
JSON format.  
...
- [SAST](./scan.md) — Static analysis that operates on similar AST structures
- [Build](./build.md) — Compiles the source files that can be analyzed with `ast`

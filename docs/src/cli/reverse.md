...
The `reverse` command performs static reverse engineering on compiled Solana sBPF bytecode (`.so` files).  
...
* `disassembly.out`: Human-readable disassembly of sBPF instructions
